        ...
        <div class="table-responsive">
            <table class="admin-table">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($service->images && count($service->images) > 0)
                                    <span class="badge bg-primary">{{ count($service->images) }} صورة</span>
                                @else
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center text-muted">لا توجد خدمات مسجلة</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
...
<div id="deleteModal" class="modal">
    <div class="modal-content">
        <form id="deleteForm" method="POST">
            ...
            <div class="modal-body">
                <p>هل أنت متأكد من حذف الخدمة <strong id="deleteName"></strong>؟</p>
